...
<div class="ch-container">
 ...
 <?php 
                error_reporting(0);
                if($_GET["page"]=="user"){
                    ?> <li><a href="index.php?page=user">User</a></li> <?php
                }
                    ...
                    ?> <li><a href="index.php?page=admin">Administrator</a></li>  <?php
                }
                    ...
                    ?> <li><a href="index.php?page=distributor">Distributor</a></li>  <?php
                }
                    ...
                    ?> <li><a href="index.php?page=produk">Produk</a></li> <?php
                }
                    ...
                    ?> <li><a href="index.php?page=kategori">Kategori</a></li> <?php
                }
